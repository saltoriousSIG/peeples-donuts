                        ...
                        <div className="relative space-y-4">
                            ...
                            <div className="flex items-center gap-4">
                                <Avatar className="h-16 w-16 ring-4 ring-white/40">
                                    ...
                                    <AvatarFallback className="text-xl">{highestBidderData?.name[0]}</AvatarFallback>
                                </Avatar>

                                <div className="flex-1">
                                    <div className="text-white text-lg font-bold">{highestBidderData?.name}</div>
                                    <div className="text-white/80 text-sm">{highestBidderData?.handle}</div>
                                </div>

                                <div className="text-right">
                                    <div className="text-4xl font-bold text-white">{parseFloat(formatUnits(currentAuction?.highestBid || 0n, 18)).toLocaleString("en-US", {
                                        minimumFractionDigits: 2,
                                        maximumFractionDigits: 2
                                    })}</div>
                                    <div className="text-sm text-white/80 uppercase tracking-wider">$PEEPLES</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                <input
                                    ...
                                    placeholder="0x..."
                                    className="w-full bg-white text-black border-2 border-[#5C946E]/20 rounded-xl px-5 py-3 text-sm placeholder:text-[#3D405B]/30 focus:outline-none focus:ring-4 focus:border-[#5C946E] focus:ring-[#5C946E]/10 transition-all font-mono"
                                />
                                <button
                                    onClick={() => {
